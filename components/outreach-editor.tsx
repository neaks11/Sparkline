...
export function OutreachEditor({ lead, onUpdate, onRegenerate }: OutreachEditorProps) {
  ...
  return (
    <div className="card p-5">
      {isMedSpaNiche(lead.niche) && (
        <p className="mb-3 text-xs text-slate-500">Tip: keep outreach centered on consultation booking friction, missed-call follow-up, and front desk automation wins.</p>
      )}
